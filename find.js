...
bitcoind -datadir=/var/cff_server/btc/bitcoind/datadir -rpcport=14545 -rpcuser=test -rpcpassword=test -conf=/var/cff_server/btc/bitcoind/bitcoin.conf -deprecatedrpc=accounts -daemon

#Remove
bitcoin-cli -conf=/var/cff_server/btc/bitcoind/bitcoin.conf stop
sudo apt-get remove bitcoind
rm -rf ~/.bitcoin
rm -rf /var/cff_server/btc/bitcoind
sudo apt autoremove
rm -rf /var/cff_server/btc
...
#Import WIF
bitcoin-cli -conf=/var/cff_server/btc/bitcoind/bitcoin.conf getaddressesbyaccount ""
#return
[
  
]

bitcoin-cli -conf=/var/cff_server/btc/bitcoind/bitcoin.conf importprivkey "KwDiBf89QgGbjEhKnhXJuH7LrciVrZi3qYjgd9M7rFU7HKMe7qaS" "checker" false

bitcoin-cli -conf=/var/cff_server/btc/bitcoind/bitcoin.conf getaddressesbyaccount "checker"
#return
...
bitcoin-cli -conf=/var/cff_server/btc/bitcoind/bitcoin.conf getbalance "checker" 
#return
0.15337710

bitcoin-cli -conf=/var/cff_server/btc/bitcoind/bitcoin.conf listaddressgroupings
#return
[
  [
    [
...
bitcoin-cli -conf=/var/cff_server/btc/bitcoind/bitcoin.conf listreceivedbyaccount

bitcoin-cli -conf=/var/cff_server/btc/bitcoind/bitcoin.conf getwalletinfo

bitcoin-cli -conf=/var/cff_server/btc/bitcoind/bitcoin.conf dumpwallet "/var/cff_server/btc/bitcoind/wallet.txt" 

bitcoin-cli -conf=/var/cff_server/btc/bitcoind/bitcoin.conf importprivkey "KwDiBf89QgGbjEhKnhXJuH7LrciVrZi3qYjgd9M7rFU73sVHnoWn" "checker" false
...
sudo nano /etc/redis/redis.conf 
	...
	redis-cli
		CONFIG SET dir /var/cff_server/btc/wif/redis
		CONFIG SET dbfilename temp.rdb
	#if error for save db
	nano /etc/systemd/system/redis.service
		#add in file
		ReadWriteDirectories=-/var/cff_server/btc/wif/redis
